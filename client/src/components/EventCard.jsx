    ...
    >
      ...
      <div className="flex flex-col p-5 text-white md:w-2/3 relative">
        ...
        <div className="flex justify-between items-start mb-2">
          ...
          {/* THREE DOTS MENU - Only show if canManage is true */}
          {canManage && (
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button
                    variant="ghost"
                    size="icon"
                    className="h-8 w-8 rounded-full bg-neutral-900/50 hover:bg-neutral-800 text-white border border-transparent hover:border-neutral-700"
