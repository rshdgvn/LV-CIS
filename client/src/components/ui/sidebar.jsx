...
// updated cva config (replace your current sidebarMenuButtonVariants)
    ...
    "group-data-[state=collapsed]:[&>span:last-child]:hidden",
  {
    variants: {
      ...
      size: {
        default: "h-8 text-sm",
        sm: "h-7 text-xs",
        lg: "h-12 text-sm group-data-[state=collapsed]:p-0!", // smaller padding when lg + collapsed
      },
    },
    defaultVariants: {
      variant: "default",
...
// SidebarMenuButton component (unchanged logic, uses the updated CVA above)
